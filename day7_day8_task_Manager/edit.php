            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              unset($_SESSION['message']);
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" name="new_image" id="taskImage" class="form-control mt-3">
                    <input   type="hidden" name="old__image" id="taskImage" class="form-control mt-3" value="<?php echo $row['task_image']; ?>">
                </div>
