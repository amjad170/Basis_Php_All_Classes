<?php 
    ...
    class SportManager extends Connection{
        ...
        public function store($allData){
            ...
            $sql = "INSERT INTO `sporttable`(`mobilename`, `Qty`, `mobileimage`, `mobileprice`) VALUES ('$mobileName','$mobileQty','$mobileImage','$mobilePrice')";
        ...
        public function show(){
           $result = $this->con->query("SELECT * FROM `sporttable`");
           return $result;
        }
        ...
        public function destroy($tid){
            ...
            $fire = $this->con->query("SELECT * FROM `sporttable` WHERE id = '$tid'");
            ...
            $result = $this->con->query("DELETE FROM `sporttable` WHERE id = '$tid'");
            if($result){
        ...
        public function update($allData, $tid){
            ...
            if(file_exists("upload/".$new__imageName)){
                ...
                $sql = "UPDATE `sporttable` SET `mobilename`='$newName',`Qty`='$newQty',`mobileimage`='$update_imageName',`mobileprice`='$newPrice' WHERE id='$tid'";
